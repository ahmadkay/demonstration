		 ...
		 <header id="header" id="home">
			...
			<section class="events-list-area section-gap event-page-lists">
				...
				<div  style="width:500px">
					<form action="changedex.php" method="POST">
						<fieldset>
							<legend>Change password</legend>
					<input type="text" placeholder="username" name="username" class="form-control" required></p>
					<input type="text" placeholder="current password" name="cpassword" class="form-control" required></p>
					<input type="text" placeholder="new password" name="npassword" class="form-control" required></p>

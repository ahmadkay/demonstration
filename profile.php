...
<legend>Parent/Sponsor Details</legend>				
<table>
				<table class="table table-striped table-bordered" id="GridView1" style="border-width:1px;border-style:Solid;border-collapse:collapse;" cellspacing="0" border="1" cellpadding="8" align="center">
<thead>								
<th>S/N</th>
...
?>
			<tr>
				...
				<td><?php echo $row['parentaddres']; ?></td>
				<td><?php echo $row['parentemail']; ?></td>
				<td><?php echo $row['sponsorname']; ?></td>
				<td><?php echo $row['sponsornumber']; ?></td>
...
?>
			<tr>
				<td><?php echo $i; ?></td>
	            <td><?php echo $row['enteryclass']; ?></td>
				<td><?php echo $row['yearforgraduation']; ?></td>

  ...
  <input type="text" placeholder="Email" name="username" class="form-control" required></p>

 <label for="email"><b>password</b></label></b>
    <input type="password" placeholder="your surname" name="password" class="form-control" required></p>
     
  
        <input type="submit" value="login" class="form-btn" name="submit" style="background:yellowgreen; color:white">
    </div>
  </div>
</form>

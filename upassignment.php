		 ...
		 <header id="header" id="home">
			...
			<section class="events-list-area section-gap event-page-lists">
				...
				<div  style="width:500px">
					<form action="assdex.php" method="POST" enctype="multipart/form-data">
						<fieldset>
					...
					<input type="date" placeholder="date" name="date" class="form-control" required></p>
					<input type="date" placeholder="sub date" name="subdate" class="form-control" required></p>
